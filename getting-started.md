...
Getting started at SALT can be overwhelming. There are a lot of little details, a number of big tasks, you're
learning a new job and new coworkers, and you're likely doing all these things while working remotely. Your SALT'
...
still nice to have a work buddy to ping when you don't know where to turn. So we set up a SALT' Buddy system.
