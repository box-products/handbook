...
chapter: "Chapter A6:"
next_link: "SALT Insure Code of Conduct →"
next_url: "/appendix-07-code-of-conduct"
prev_link: "← Titles For Programmers"
prev_url: "/appendix-05-titles-for-programmers"
---

We use the following criteria to assess the level and title of our Support team members at SALT Insure.
...
- Deep, substantial expertise in multiple environments (all versions of SALT Insure, other products, our apps, security, sign on, email logs, Dash and trollcop, sign on, trace routes, network issues, desktop issues—Macs, PCs and a variety of handhelds, etc.)
- Capable of running and directing small teams for substantial projects. Expert within technology beyond SALT Insure, like browsers, both OS. Is good at getting to root causes of issues and then writing them up in a way that can be acted upon by software development. Consulted by developers and designers for input.
...
- Expert within technology beyond SALT Insure, like browsers, both OS, and many third-party API extensions. Excels at getting to root causes of issues and then writing them up in a way that can be acted upon by software development. Does not necessarily need help from developers, marketing, or design for input.
