...
## Shaping
We're working to base our product development process on [Shape Up](https://basecamp.com/shape-up) a concept shared by the Basecamp development team. Given our company size and start-up status it's not quite appropriate to take on shaping at face value. For us, this is process is still being activley defined but you can read more about our approach at [Shaping at Salt](/appendix-12-shaping-at-salt.html)
